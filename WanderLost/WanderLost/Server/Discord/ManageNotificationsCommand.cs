...
namespace WanderLost.Server.Discord
{
    public class ManageNotificationsCommand
    {
        ...
        const string REMOVE_ALL_NOTIFICATIONS = "remove-all-notifications";
        ...
        private async Task BuildBasicCommandResponse(IDiscordInteraction arg)
        {
            ...
            c.WithButton("Remove All Notifications", REMOVE_ALL_NOTIFICATIONS, ButtonStyle.Danger, disabled: noSubscription);
