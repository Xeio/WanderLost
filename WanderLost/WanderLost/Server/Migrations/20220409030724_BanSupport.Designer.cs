...
namespace WanderLost.Server.Migrations
{
    ...
    [Migration("20220409030724_BanSupport")]
    partial class BanSupport
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WanderLost.Shared.Data.ActiveMerchant", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("ActiveMerchant");
                });
            ...
            modelBuilder.Entity("WanderLost.Server.Data.HiddenMerchant", b =>
                {
                    b.HasBaseType("WanderLost.Shared.Data.ActiveMerchant");

                    b.HasDiscriminator().HasValue("HiddenMerchant");
                });
